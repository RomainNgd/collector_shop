...
export const options = {
  ...
  scenarios: {
    scale_up_probe: {
      ...
      stages: [
        // Rampe progressive: le HPA a besoin de ~30-60s de metriques sur un
        // pod Ready avant de creer une replique. Un warmup trop violent
        // sature le pod avant que l'autoscaling ait pu reagir.
        { duration: __ENV.WARMUP_DURATION || '60s', target: Number(__ENV.WARMUP_VUS || 15) },
