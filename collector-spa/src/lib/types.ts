...
export const mapApiSellerStats = (item: ApiSellerStats): SellerStats => ({
	totalRevenue: typeof item.total_revenue === 'number' ? item.total_revenue : 0,
	totalSales: typeof item.total_sales === 'number' ? item.total_sales : 0,
